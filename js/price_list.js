function get_price(item_selected){
    ...
    /*red chilli powder price*/
    else if(item_selected == "50gmrcpquantity")
    {
      var x = document.getElementById('50gmrcp')
      x.value = "12"
      var quantity = document.getElementById("50gmrcpquantity").value
      document.getElementById("price18").value = x.value * quantity;
    }
    else if(item_selected == "100gmrcpquantity")
    {
      var x = document.getElementById('100gmrcp')
      x.value = "23"
      var quantity = document.getElementById("100gmrcpquantity").value
      document.getElementById("price19").value = x.value * quantity;
    }
    /*total price*/
    var total = 0;
