...
<div class="left" style="border:2px solid #CE212D;border-radius:10px">
      <div class="links">
        <ul>
            <li class="linkleft1">
              <a href="productssub">
              <img src="images/allprd.jpg" style="width:178px;height:240px;margin:10px;">
...
<div class="right" style="border:2px solid #CE212D;border-radius:10px">
      <div class="links">
          <ul>
             <li class="linkleft1">
              <a href="instantfood" title="">
                <img src="images/slide_one.jpg" style="width:178px;height:240px;margin:10px;">
              <em>Instant Foods</em>
