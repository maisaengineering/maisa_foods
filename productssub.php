...
<div class="products">
		<div style="background-color:#CE212D;padding:10px"><h1 style="color:#ffffff;margin:10px;">Spices</h1></div>
		<div class="left">
			<div class="links">
        <ul>
                 <li class="linkleft1">
                  <a href="product1" title="Garam Masala">
                  <div class="products_sprite masala7">
                  <em>Garam Masala</em>
		...
		<div class="right">
          ...
          <ul>
                ...
                <div class="products_sprite masala4">
        ...
        <ul>
                 <li class="linkleft1">
                  <a href="product3" title="Rasam Powder">
                <div class="products_sprite masala5">
                  <em>Rasam Powder</em>
      ...
      <ul>
                 <li class="linkleft1">
                  <a href="product4" title="Sambar Powder">
                <div class="products_sprite masala6">
                  <em>Sambar Powder</em>
        ...
        <ul>
                 <li class="linkleft1">
                  <a href="product5" title="Biryani Masala">
                <div class="products_sprite masala8">
      ...
      <ul>
                 <li class="linkleft1">
                  <a href="product6" title="Chicken Masala">
                <div class="products_sprite masala2">
        ...
        <ul>
                 <li class="linkleft1">
                  <a href="product7" title="Mutton Masala">
                <div class="products_sprite masala3">
                  <em>Mutton Masala</em>
      ...
      <ul>
                 <li class="linkleft1">
                  <a href="product8" title="Instant Chicken Masala">
                <div class="products_sprite masala1">
